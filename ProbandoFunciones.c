...
void limpiarBufer(int Bufer[] ,int tamanoBufer);
...
inicio:   //Punto de retorno
   ...
   {   
      ...
      timeOut=0;
      punto=0;
      limpiarBufer(Bufer,sizeof(Bufer));
      ...
      ingresarDatos(Bufer,terminadoRDA,contador15s,sizeof(Bufer),datoMalo,punto,posicion);                                          
      ///Validaciones
